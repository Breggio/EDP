...
Final_ErrSmoothed_X = sqrt( 1/(M-1) * sum(SqrError_X) ); %true estimation error of coordinate smoothed
Final_ErrSmoothed_V = sqrt( 1/(M-1) * sum(SqrError_V) ); %true estimation error of velocity smoothed

Final_ErrNOTSmoothed_X = sqrt( 1/(M-1) * sum(SqrError_X_NOTsm) ); %true estimation error of coordinate
Final_ErrNOTSmoothed_V = sqrt( 1/(M-1) * sum(SqrError_V_NOTsm) ); %true estimation error of velocity
